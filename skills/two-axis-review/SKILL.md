...
Anything in the repo that documents how code should be written, such as `CODING_STANDARDS.md`, `CONTRIBUTING.md`, or a conventions section in `CLAUDE.md`.
...
<!-- Adapted from mattpocock/skills code-review (MIT), renamed to avoid the built-in /code-review; see skills/NOTICE.md -->
